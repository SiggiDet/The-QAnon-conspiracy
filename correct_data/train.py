...
if __name__ == '__main__':
    ...
    if not params.tune:
        ...
        for i in models:
            print(str(i.summary()))
        print(str(best_model.summary()))
        print(str(tuner.results_summary()))
        for i in models:
            logging.info(str(i.summary()))
        logging.info(str(best_model.summary()))
        logging.info(str(tuner.results_summary()))
